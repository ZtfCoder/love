...
new THREE.OBJLoader().load("https://fastly.jsdelivr.net/gh/ZtfCoder/love/js/heart_2.obj", (obj) => {
...
function addTextGeometry(text) {
  ...
  loader.load("https://fastly.jsdelivr.net/gh/ZtfCoder/love/js/MaokenAssortedSans_Regular.json", function (res) {
    var geometry = new THREE.TextGeometry(text + "", {
      ...
      bevelThickness: 0, // 斜角的深度
      bevelSize: 0, // 斜角的大小
      bevelSegments: 0, // 斜角段数
    });
